...
TOPICS.extend(
    [
        ...
        _topic(
            ...
            ("Choose: thank you<br>A) Gracias.<br>B) Por favor.", "A) Gracias.", "Gracias means thank you."),
            ("Estoy siento.", "Lo siento.", "Lo siento is the fixed phrase for I am sorry."),
            ("Write in Spanish: Please.", "Por favor.", "por favor is the fixed polite phrase."),
